---
---
const staticCacheName = 'static-cache-novchurch-songs-v002';
const dynamicCacheName = 'dynamic-cache-novchurch-songs-v002';

const staticAssets = [
    '{{ "/" | relative_url }}',
    '{{ "/alphabet/" | relative_url }}',
    {% for post in site.posts %}'{{ post.url | relative_url }}',
    {% endfor %}'{{ "/images/icons/icon-144x144.png" | relative_url }}',
